...
from handlers.callback import ll_callback, ol_callback, bl_callback, fl_callback, dl_callback
...
def callback_query(bot, update):
    ...
    if query_params[0] == "ll":
        ...
        send_msg, keyboard_list = fl_callback.exec(query.from_user, query_params)
